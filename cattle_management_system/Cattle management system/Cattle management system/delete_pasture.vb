...
Public Class delete_pasture
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Try
            com.Connection = con
            com.CommandText = "delete from pasture where id = '" & id & "' "
            com.ExecuteNonQuery()
    ...
    '    End If
    'End Sub
    Private Sub delete_pasture_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Dim adapt As OleDbDataAdapter
        Dim adaptt As OleDbDataAdapter
        Dim dt As DataTable
        Dim dt1 As DataTable
