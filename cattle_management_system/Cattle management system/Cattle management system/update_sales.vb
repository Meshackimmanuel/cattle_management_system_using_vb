...
Public Class update_sales

    Private Sub update_sales_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            adaptt = New OleDbDataAdapter("select sales_id from sales ", con)
            dt = New DataTable
            dt1 = New DataTable
            adapt.Fill(dt)
            adaptt.Fill(dt1)
            ...
            ComboBox2.DisplayMember = "sales_id"
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Dim strQ As String = "SELECT sales_id,amount,date,customer_name,customer_no,type FROM sales WHERE sales_id = '" & sid & "'"
        ...
        If QReader.HasRows Then
            While QReader.Read
                pid = QReader.Item("sales_id")
                amount = QReader.Item("amount")
                dat = QReader.Item("date")
                dob = dob.ToString("dd MMM, yyyy")
                sname = QReader.Item("customer_name")
                sno = QReader.Item("customer_no")
        ...
        If CheckBox6.Checked Then
            ...
            If TextBox4.Text = "" Then
                MsgBox("kindly enter the customer number")
                TextBox4.Focus()
                Exit Sub
            End If
        End If
        ...
        Try
            com.Connection = con
            com.CommandText = "update sales set sales_id = '" & pid & "',date = convert(datetime2,'" + dat + "',20),customer_name='" & sname & "',amount=" & amount & ",customer_no=" & sno & ",type='" & type & "' where sales_id ='" & sid & "'"
            com.ExecuteNonQuery()
