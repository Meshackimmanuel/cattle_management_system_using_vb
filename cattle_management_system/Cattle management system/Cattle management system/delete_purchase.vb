...
Public Class delete_purchase

    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        Dim id As String = Trim(ComboBox1.Text)
        If ComboBox1.Text = "" Then
            MsgBox("kindly enter purchase id")
            ComboBox1.Focus()
            Exit Sub
        End If
        ...
        Try
            com.Connection = con
            com.CommandText = "delete from purchase where purchase_id = '" & id & "' "
            com.ExecuteNonQuery()
            ...
            Try
                ...
                ComboBox1.DisplayMember = "purchase_id"
    ...
    '    End If
    'End Sub
    Private Sub delete_purchase_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Dim adapt As OleDbDataAdapter
        Dim adaptt As OleDbDataAdapter
        Dim dt As DataTable
        Dim dt1 As DataTable
