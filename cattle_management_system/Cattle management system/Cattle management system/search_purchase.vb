...
Public Class search_purchase
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Else
            ...
            If type = "pasture" Then
                sql = "select * from purchase where type= 'p'"
            ElseIf type = "cattle" Then
                sql = "select * from purchase where type= 'c'"
            Else
    ...
    '    End If
    'End Sub
    Private Sub search_purchase_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Dim adapt As OleDbDataAdapter
        Dim dt As DataTable
        Try
